...
const aspectStyle = computed<StyleValue>(() => {
...
const figureStyle = computed<StyleValue>(() => attrs.style as StyleValue)
...
const displayedImageStyle = computed<StyleValue>(() => (
...
onMounted(syncLoadedImageState)
...
<template>
  <figure
    ...
    :class="[attrs.class, figureFrameClass]"
    :style="figureStyle"
  >
    <div
      ref="imageWrapRef"
